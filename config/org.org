...
#+BEGIN_SRC emacs-lisp
	(setq org-agenda-sorting-strategy
				'((agenda time-up todo-state-down deadline-up schedule-up effort-up priority-down tag-up category-keep)
					(todo   todo-state-down deadline-up schedule-up effort-up priority-down tag-up category-keep)
					(tags   todo-state-down deadline-up schedule-up effort-up priority-down tag-up category-keep)
					(search todo-state-down deadline-up schedule-up effort-up priority-down tag-up category-keep)))
#+END_SRC
	...
	; GTD tags
						("k" "Kanban for GTD TAGS"
						 ((tags "LEVEL=1+PROJECT")
							...
							(tags "+WAITING")
							(tags "+BREAKDOWN")
						  (tags "-PROJECT-NEW-FLAGGED-VERIFY-DELEGATE-WAITING-BREAKDOWN/|NEXT|TODO")
	))
						("h" "Habits"
