...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key org-agenda-mode-map "\C-ce" 'rjh/org-tags-expire)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
	(setq org-todo-keywords
		 ...
		 (sequence "EVENT(e!)" )
	   (type "STUDY(s!)" "ALPHA" "BETA" "GAMMA" "DELTA" "THETA" "|" "NU")))
...
This *example* will exclude a select list of tags from being inherited.
...
#+BEGIN_SRC emacs-lisp
	(setq org-capture-templates
				'(("t" "Todo" entry (file+headline rjh/org-tasks "Inbox")
					 "* TODO %? :NEW:\n\t%i\n\t%a\n\n" nil)
					 ("l" "Learn" entry (file+headline rjh/org-tasks "Inbox")
					 "* TODO %^{prompt} :NEW:\n\t%i%?\n** STUDY %\\1 \nSCHEDULED: <%(org-read-date nil nil \".\")>\n** ALPHA %\\1 \nSCHEDULED: <%(org-read-date nil nil \"+1h\")>\n** BETA  %\\1 \nSCHEDULED: <%(org-read-date nil nil \"+1d\")>\n** GAMMA %\\1 \nSCHEDULED: <%(org-read-date nil nil \"+14d\")>\n** DELTA %\\1 \nSCHEDULED: <%(org-read-date nil nil \"+28d\")>\n** THETA %\\1 \nSCHEDULED: <%(org-read-date nil nil \"+56d\")>\n"
					 nil)
