...
Loads patched functions from below:
   #+begin_src emacs-lisp
     (load-file (concat user-emacs-directory "/rjh/patch/solar/org.el"))
   #+end_src
...
** org-agenda.el patches
   ...
   #+begin_src emacs-lisp
     (load-file (concat user-emacs-directory "/rjh/patch/solar/org-agenda.el"))
   #+end_src
...
** ox-icalendar.el patches
   *Warning! sexps must be in the headline in order to be interpreted. (For the moment)*
   ...
   #+begin_src emacs-lisp
     (load-file (concat user-emacs-directory "/rjh/patch/solar/ox-icalendar.el"))
   #+end_src
...
** icalendar.el patches
   ...
   #+begin_src emacs-lisp
     (load-file (concat user-emacs-directory "/rjh/patch/solar/icalendar.el"))
   #+end_src
