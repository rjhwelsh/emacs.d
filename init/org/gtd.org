...
Skips each item unless it qualifies as a project.
	...
	(setq org-agenda-project-skip-function 
		...
		(org-agenda-skip-invert                  ;; (Do not ... )
		 'org-agenda-skip-if-children            ;; (skip if any children are ... )       
		 'org-agenda-skip-entry-if 'todo '("*")) ;; (... any todo item)
		;; BUT ... Skip if ..
		(and 
...
***** Match project which can be archived
  Projects to archive.
