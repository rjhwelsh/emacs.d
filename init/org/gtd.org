...
***** Obtain the character marker for the parent entry
      #+begin_src emacs-lisp
	(defun org-score-get-parent-pom (pom)
     ...
     #+begin_src emacs-lisp
       (setq org-score-vector 
	     `(;; Todo-state scoring
	       ...
	       ((lambda (pom) (org-score-get-todo-state-number (org-score-get-parent-point pom))) 2000 2000)
		...
		0 2000)
	       ((lambda (pom)
		  (let* ((pom (org-score-get-parent-point pom))
