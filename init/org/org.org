...
#+begin_src emacs-lisp
  ...
  (defun org-id-refile-to-prev ()
    ...
    (let ((PPID (org-id-find                ;; Find location of org-id
		 (org-entry-get nil "PPID") ;; Get property value at point
		 )))
      (org-refile nil nil
		  (list nil (car PPID) nil (cdr PPID))  ;; RFLOC
		  )))
#+end_src
...
#+begin_src emacs-lisp
  (defun org-set-ppid-to-current ()
    ...
    (org-set-property "PPID"		             ;;
		      (save-excursion	             ;;
			(condition-case nil          ;; Catch any error
