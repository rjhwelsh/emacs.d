	...
	(let (
		...
		(let (
					...
					(agenda-view
					 (lambda (&optional settings filename exts)
						 `(agenda "" ,settings
											,(funcall filename-to-export-views (concat filename "agenda") exts))
						 ))
					...
					(other-tags-view
					 (lambda (&optional settings filename exts)
						 `(tags-todo
							 ...
							 ,(funcall filename-to-export-views (concat filename "tag_OTHER") exts)
							 )
						 ))
					...
					(stuck-view
					 (lambda (&optional settings filename exts)
						 `(stuck ""
										 ,settings
										 ,(funcall filename-to-export-views (concat filename "stuck") exts)
										 )
						 ))
						 ...
						 (append
							...
							(mapcar 'cdr
											(funcall tag-persistent-agenda-views
															 ...
															 exts))
							`(
								,(funcall other-tags-view settings filename exts)
								,(funcall stuck-view settings filename exts)
								))
						 ))
			...
			(setq org-agenda-custom-commands
						(append
						 `(
							 ...
							 ("t" . "Todo items with specific persistent tags")
							 ("A" "Agenda View" . ,(funcall agenda-view '((org-agenda-span 1)) "agenda/" '("ps" "html")))
							 ("O" "Other tags (EXPORT)" . ,(funcall other-tags-view nil "agenda/" '("ps" "html")))
							 ("S" "Stuck projects (EXPORT)" . ,(funcall stuck-view nil "agenda/" '("ps" "html")))
							 )
