			...
			(setq org-agenda-custom-commands
						(append
						 `(
							 ...
							 ("A" "Agenda View" . ,(funcall agenda-view '((org-agenda-span 1)) "agenda/agenda" '("ps" "html")))
							 ("O" "Other tags (EXPORT)" . ,(funcall other-tags-view nil "agenda/tag/OTHER" '("ps" "html")))
							 ("S" "Stuck projects (EXPORT)" . ,(funcall stuck-view nil "agenda/stuck" '("ps" "html")))
							 )
